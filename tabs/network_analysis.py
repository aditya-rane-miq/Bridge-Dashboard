...
if __name__ == "__main__":
    fig = create_gender_org_chart()
    fig.show()

    # Create organizational chart
    G = create_org_chart()
    
    # Analyze network centralities
    employee_df, female_distances_df = analyze_org_network_centralities(G)
    
    # Analyze leadership gender equality
